...
data profile_results_column_metrics
        (keep=
     ...
     profile_results_tableinfo
         (keep=table_source_caslib_name table_source_table_name table_creation_date table_modification_date table_nrows)
     profile_results_frequencies_high 
         (keep=column_name column_type freq_value_num freq_value_char freq_count)
     profile_results_frequencies_low 
         (keep=column_name column_type freq_value_num freq_value_char freq_count)
     profile_results_patterns_high 
         (keep=column_name column_type pattern_char pattern_count)
     profile_results_patterns_low
         (keep=column_name column_type pattern_char pattern_count)
     profile_results_idanalysis
         (keep=column_name column_type id_type id_score)
     profile_results_outliers_high
         (keep=column_name column_type outlier_value_num outlier_value_char outlier_count)
     profile_results_outliers_low
         (keep=column_name column_type outlier_value_num outlier_value_char outlier_count)
     ;
   ...
   /* but does not specify the physical order in the output table    */ 
    ...
    retain
        ...
        ;
    retain
        table_source_caslib_name table_source_table_name table_creation_date table_modification_date table_nrows
        ;
   ...
   */
        ...
        select (rowid);
            ...
            when(1004) do;
                ...
                */ 
                ...
                freq_count = Count;
                output profile_results_frequencies_high;
            end;
            when(1005) do;
                ...
                */
                ...
                freq_count = Count;
                output profile_results_frequencies_low;
            end;
            when(1006) do;
                link get_metric_value;
            ...
            when(1016) do;
                 ...
                 outlier_count = Count;
                 output profile_results_outliers_high;
            end;
            when(1017) do;
                ...
                outlier_count = Count;
                output profile_results_outliers_low;
            end;
            when(1018) do;
                /* Pattern high frequency */
                pattern_char = CharValue;
                pattern_count = Count;
                output profile_results_patterns_high;
            end;
            when(1019) do;
                /* Pattern low frequency */
                pattern_char = CharValue;
                pattern_count = Count;
                output profile_results_patterns_low;
            end;
            ...
            when(1028) do;
                ...
                */
                ...
                output profile_results_idanalysis;
            end;
    ...
    if last.ColumnId then do;
        ...
        */
        if ColumnId = -1 then do;
            output profile_results_tableinfo;
        end;
        else do;
            output profile_results_column_metrics;
        end;
    end;
